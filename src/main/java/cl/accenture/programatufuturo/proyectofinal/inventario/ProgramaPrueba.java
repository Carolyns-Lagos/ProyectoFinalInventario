...
public class ProgramaPrueba {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //calcular precio con productos
        //asignar el valor  a la boleta
        // guardar la boleta
...
//        Usuario usuario = new Usuario("1888","Jua Perez","hola@gmail.com",5558684,"1234aa","VENDEDOR", sucursal);
//
...
//        System.out.println("Contraseña Desencriptada="+contraseñaDesencriptada2);
        ...
        //Prueba ingresar venta

//        Producto producto=new Producto("hola","raro",5,10,1000,"hosh","celular");
////        VentaDAO venta= new VentaDAO();
////        venta.ingresarVenta(producto, 3);
...
//        Date x=new Date();
//        java.sql.Date a = (java.sql.Date)x;
